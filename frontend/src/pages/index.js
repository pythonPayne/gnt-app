...
const Index = () => {
  ...
  return (
    <Layout>
        ...
        <svg id="my-svg-id" viewBox="0 0 244 86" xmlns="http://www.w3.org/2000/svg"
          className={`h-[86px] w-[244px] transition-all ease-in duration-[2500ms] stroke-[3]
          ${svgFill === 'none' ? "fill-gray-700 stroke-white" : "fill-gray-100 stroke-gray-100"}`}
