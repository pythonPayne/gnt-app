...
const Word = (props) => {  
  ...
  if(lexn && pdgm) {return (
    <Layout>
      ...
      {/* word banner */}
      <div>
          <div className={`flex justify-center items-center h-[12vh] border-b bg-white text-3xl text-gray-600`}>      
            {lexn.lexnGreek}
          </div>
      </div>  
      ...
      <div className="sticky top-0 border-b bg-white">
         <div className={`grid grid-cols-3 gap-x-3 py-2 mx-3`}>
          
            <div className={`flex justify-center py-2 cursor-pointer
            ${sectionShowing === 'lexicon' ? "bg-green-200 rounded" : "text-gray-500"}`}
            onClick={() => dispatch(setSectionShowing('lexicon'))}>
              Lexicon
            </div>

            <div className={`flex justify-center py-2 cursor-pointer
            ${sectionShowing === 'usage' ? "bg-green-200 rounded" : "text-gray-500"}`}
            onClick={() => dispatch(setSectionShowing('usage'))}>
              Usage
            </div>            
  
            <div className={`flex justify-center py-2 cursor-pointer
            ${sectionShowing === 'parsing' ? "bg-green-200 rounded" : "text-gray-500"}`}
      ...
      <div className={`mx-2 mt-6 min-h-screen mb-24`}>      
      ...
      <div className={`min-h-screen`}>
         <div className="flex justify-center py-10 space-x-1 bg-white border-b sticky top-0">        
      ...
      <div className={``}>
        ...
        {/* bar chart */}
        <div className={`sticky top-0 border-b px-3 py-6 bg-white`}>    
